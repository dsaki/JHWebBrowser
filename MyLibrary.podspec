...
Pod::Spec.new do |s|
  ...
  s.name         = "JHWebBrowser"
  s.version      = "0.0.1"
  s.summary      = "Simple web browser."

  s.description  = <<-DESC
                   A longer description of MyLibrary in Markdown format.
  ...
  s.source       = { :git => "https://github.com/dsaki/JHWebBrowser.git", :tag => "0.0.1" }
